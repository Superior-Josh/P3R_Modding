...
- [x] Sprint 3 安全系统完成并复验通过：registry v2、`mod.json` / `history.json`、Git pre-mod backup、命名备份、回滚预览、冲突分级、post-patch guard；详见 [SECURITY.md](SECURITY.md) 与 [SPRINT_3_TEST_REPORT.md](SPRINT_3_TEST_REPORT.md)
...
| 验收记录 | [SPRINT_3_TEST_REPORT.md](SPRINT_3_TEST_REPORT.md) | 非破坏性 CLI smoke、冲突阻断、重复运行修复 |
...
| Sprint 1.5 剩余限制 / guard 输入 | `docs/SPRINT_1_5_TODO.md` |
| UnrealEssentials 参考 | `docs/UNREAL_ESSENTIALS_REFERENCE.md` |
| 安全协议 | `docs/SECURITY.md` |
| Sprint 3 验收报告 | `docs/SPRINT_3_TEST_REPORT.md` |
