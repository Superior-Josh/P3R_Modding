...
│   ├── MOD_SPECIFICATION.md         ← Mod 生成规范 (ModConfig/PAK/依赖) ★
│   └── amicitia/
...
> **完整规范**: 见 [docs/MOD_SPECIFICATION.md](docs/MOD_SPECIFICATION.md) — 包含 ModConfig.json 字段说明、ModId 命名规范、依赖链、PAK 格式、验证清单等。

**最小 ModConfig.json 模板:**
```json
{
  "ModId": "p3r.<your-mod-id>",
  "ModName": "P3R - <Your Mod Name>",
  "ModAuthor": "<Author>",
  "ModVersion": "1.0.0",
...
| `docs/MOD_SPECIFICATION.md` | Mod 生成规范：ModConfig.json、PAK 格式、依赖链、验证清单 |
